...
def load_evaluation_results():
    ...
    with open('results/model_evaluation/evaluation_results.json', 'r') as f:
        return json.load(f)
...
def main():
    ...
    # Save as HTML
    fig.write_html('results/ensemble_evaluation/confusion_matrix.html')
    ...
    with open('results/ensemble_evaluation/confusion_matrix_metrics.json', 'w') as f:
